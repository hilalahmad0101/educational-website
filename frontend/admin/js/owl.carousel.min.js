  ...
  e.Defaults = {
    ...
    e.prototype.initializeItems = function () {
      ...
      this.replace(this.$element.children().not(this.$stage.parent())),
        ...
        this.$element.removeClass(this.options.loadingClass).addClass(
    ...
    e.prototype.prepare = function (b) {
      ...
      return c.data ||
        (c.data = a("<" + this.settings.itemElement + "/>").addClass(
    ...
    e.prototype.onDragStart = function (b) {
      ...
      3 !== b.which && (a.support.transform
        ...
        : (d = this.$stage.position(),
          d = {
            x: this.settings.rtl
              ? d.left + this.$stage.width() - this.width() +
                this.settings.margin
              : d.left,
            y: d.top,
          }),
    ...
    e.prototype.closest = function (b, c) {
      ...
      return this.settings.freeDrag || a.each(
        ...
        this.settings.loop || (this.op(b, ">", h[this.minimum()])
          ? e = b = this.minimum()
      ...
      this.$stage.empty(),
        ...
        b.filter(function () {
          ...
          b = this.prepare(b),
            ...
            this._mergers.push(
              1 *
                  b.find("[data-merge]").addBack("[data-merge]").attr(
                    "data-merge",
                  ) || 1,
            );
        }, this)),
    ...
    e.prototype.destroy = function () {
      ...
      this.$stage.children(".cloned").remove(),
        ...
        this.$stage.remove(),
        this.$element.removeClass(this.options.refreshClass).removeClass(
          this.options.loadingClass,
        ).removeClass(this.options.loadedClass).removeClass(
          this.options.rtlClass,
        ).removeClass(this.options.dragClass).removeClass(
          this.options.grabClass,
        ).attr(
          "class",
          this.$element.attr("class").replace(
    ...
    e.prototype.trigger = function (b, c, d, f, g) {
      ...
      return this._supress[b] || (a.each(this._plugins, function (a, b) {
        ...
        this.settings && "function" == typeof this.settings[i] &&
  ...
  function (a, b, c, d) {
    ...
    e.Defaults = { autoRefresh: !0, autoRefreshInterval: 500 },
      ...
      e.prototype.destroy = function () {
        ...
        for (
          c in Object.getOwnPropertyNames(this)
        ) {
      ...
      this._core = b,
        ...
        this._handlers = {
          "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a
            .proxy(function (b) {
              if (
                b.namespace && this._core.settings &&
    ...
    e.Defaults = { lazyLoad: !1, lazyLoadEager: 0 },
      e.prototype.load = function (c) {
        var d = this._core.$stage.children().eq(c),
          e = d && d.find(".owl-lazy");
        !e || a.inArray(d.get(0), this._loaded) > -1 ||
      ...
      e.prototype.destroy = function () {
        ...
        for (
          b in Object.getOwnPropertyNames(this)
        ) {
        ...
        this._handlers = {
          ...
          "changed.owl.carousel": a.proxy(function (a) {
            a.namespace && this._core.settings.autoHeight &&
              "position" === a.property.name && this.update();
          }, this),
    ...
    e.Defaults = { autoHeight: !1, autoHeightClass: "owl-height" },
      e.prototype.update = function () {
        ...
        a.each(e, function (b, c) {
          ...
          this._core.$stage.parent().height(g).addClass(
        ...
        this._playing ||
          (this._core.enter("playing"),
            ...
            "youtube" === f.type
              ? c.attr(
                "src",
                "//www.youtube.com/embed/" + f.id + "?autoplay=1&rel=0&v=" +
                  f.id,
              )
              : "vimeo" === f.type
              ? c.attr(
            ...
            a(c).wrap('<div class="owl-video-frame" />').insertAfter(
              e.find(".owl-video"),
            ),
  ...
  function (a, b, c, d) {
    ...
    e.Defaults = { animateOut: !1, animateIn: !1 },
      e.prototype.swap = function () {
        if (
          1 === this.core.settings.items && a.support.animation &&
          a.support.transition
        ) {
          this.core.speed(0);
          var b,
          ...
          this.core.current() !== this.previous &&
            (g &&
              (b = this.core.coordinates(this.previous) -
                ...
                d.one(a.support.animation.end, c).css({ left: b + "px" })
                  .addClass("animated owl-animated-out").addClass(g)),
              f &&
              e.one(a.support.animation.end, c).addClass(
                "animated owl-animated-in",
              ).addClass(f));
        }
      },
      e.prototype.clear = function (b) {
        a(b.target).css({ left: "" }).removeClass(
        ...
        this._handlers = {
          ...
          "mouseover.owl.autoplay": a.proxy(function () {
            this._core.settings.autoplayHoverPause &&
              this._core.is("rotating") && this.pause();
          }, this),
          "mouseleave.owl.autoplay": a.proxy(function () {
            this._core.settings.autoplayHoverPause &&
              this._core.is("rotating") && this.play();
          }, this),
  ...
  function (a, b, c, d) {
    ...
    var e = function (b) {
      this._core = b,
        ...
        this._handlers = {
          "prepared.owl.carousel": a.proxy(function (b) {
            b.namespace && this._core.settings.dotsData &&
              this._templates.push(
                '<div class="' + this._core.settings.dotClass + '">' +
                  a(b.content).find("[data-dot]").addBack("[data-dot]").attr(
                    "data-dot",
                  ) + "</div>",
              );
          }, this),
    ...
    e.Defaults = {
      ...
      e.prototype.initialize = function () {
        ...
        this._controls.$relative = (c.navContainer
          ...
          .addClass("disabled"),
          this._controls.$previous = a("<" + c.navElement + ">").addClass(
            c.navClass[0],
          ).html(c.navText[0]).prependTo(this._controls.$relative).on(
            "click",
            a.proxy(function (a) {
              this.prev(c.navSpeed);
            }, this),
          ),
          this._controls.$next = a("<" + c.navElement + ">").addClass(
            c.navClass[1],
          ).html(c.navText[1]).appendTo(this._controls.$relative).on(
            "click",
            a.proxy(function (a) {
          ...
          c.dotsData ||
          (this._templates = [
            a('<button role="button">').addClass(c.dotClass).append(a("<span>"))
              .prop("outerHTML"),
          ]),
      ...
      e.prototype.draw = function () {
        ...
        this._controls.$relative.toggleClass("disabled", !c.nav || d),
          ...
          (b = this._pages.length - this._controls.$absolute.children().length,
            ...
            this._controls.$absolute.children().eq(
              a.inArray(this.current(), this._pages),
            ).addClass("active"));
      },
    ...
    var e = function (c) {
      this._core = c,
        ...
        this._handlers = {
          ...
          "prepared.owl.carousel": a.proxy(function (b) {
            if (b.namespace) {
              var c = a(b.content).find("[data-hash]").addBack("[data-hash]")
                .attr("data-hash");
              if (!c) return;
