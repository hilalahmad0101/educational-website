<div>
    ...
    <x-slot name="title">Update Offer</x-slot>
    <div class="container">
        <a href="{{ route('admin.get-offer') }}" class="previous" id="previous">&laquo; Previous</a>
        ...
        <div class="main__page__content">
            <div class="main__heading">
                <div class="main__left">
                    <h1 class="main__left__h1">Update Service</h1>
            ...
            <div class="main__page__form">
                <div class="main__page__form__left">
                    ...
                    <a href="#" class="nav-link {{ $offer_count == 3 ? 'active' : '' }}">Icon</a>
                    ...
                    <form wire:submit.prevent='update({{ $edit_id }})'>
                        ...
                        @if ($offer_count == 2)
                            <div class="main__page__section1">
                                ...
                                <div class="main__page__form__image">
                                    ...
                                    <input type="file" wire:model='new_image' name="myfile" />
                        ...
                        @if ($offer_count == 3)
                            <div class="main__page__section2">
                                ...
                                <div class="main__page__form__image">
                                    <i class="fa-solid fa-images"></i>
                                    <input type="file" wire:model='new_icon' name="myfile" />
                                    <p class="main__page__form__image__p">Drag and Drop an image, or <span>Browse</span>
                                    </p>
                                </div>
