            ...
            <div class="main__heading">
                ...
                <div class="main__right">
                    ...
                    <button class="main__right__btn">
                        <a href="{{ route('admin.add-offer') }}"> <i class="fa-solid fa-plus"></i></a>
                    </button>
                </div>
            </div>
                    ...
                    <table class="table">
                        ...
                        <tbody style="vertical-align: middle">
                            @forelse ($offers as $offer)
                                <tr>
                                    <td>{{ $offer->id }}</td>
                                    <td><img src="{{ asset('storage') }}/{{ $offer->icon }}" width="50"
                                            height="50" alt=""></td>
                                    <td>
                                        <h3 class="table__main__page__h3">{{ $offer->title }}</h3>
                                        <p class="table__main__page__p">{{ $offer->description }}</p>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li><a class="dropdown-item"
                                                        wire:click.prevent='delete({{ $offer->id }})'
                                                        href="#">Delete</a></li>
                                            </ul>
                                        </div>
                                    </td>
