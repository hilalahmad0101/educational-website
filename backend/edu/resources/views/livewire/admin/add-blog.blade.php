<div>
    ...
    <div class="container">
        <a href="{{ route('admin.get-blog') }}" class="previous" id="previous">&laquo; Previous</a>
        ...
        <div class="main__page">
            <i class="fa-solid fa-house-user"></i> <span> > Blog</span>
        </div>
        <div class="main__page__content">
            ...
            <div class="main__page__form">
                <div class="main__page__form__left">
                    ...
                    <a href="#" class="nav-link {{ $offer_count == 3 ? 'active' : '' }}">Category</a>
                    <a href="#" class="nav-link {{ $offer_count == 4 ? 'active' : '' }}">Author</a>
                    <a href="#" class="nav-link {{ $offer_count == 5 ? 'active' : '' }}">Title & Description</a>
                </div>
                    ...
                    <form wire:submit.prevent='store'>
                        ...
                        @if ($offer_count == 3)
                            <div class="main__page__section2">
                                ...
                                <p class="main__page__form__right__p">
                                    This information will be displayed on card and detail page
                                </p>
                        ...
                        @if ($offer_count == 4)
                            <div class="main__page__section2">
                                ...
                                <div class="main__page__form__cont">
                                    <select name="" wire:model='author' id="form__control">
